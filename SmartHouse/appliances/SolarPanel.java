...
public class SolarPanel extends GeneratingAppliance {
	...
	/**
	 * Constructor of a soral panel from super. In case the parameters are
	 ...
	 */
	public SolarPanel(int electricityUse, int gasUse, int waterUse)
	{
